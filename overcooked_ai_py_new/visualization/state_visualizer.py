...
class StateVisualizer:
    ...
    def _render_players(self, surface, players):
        self._ensure_player_colors(len(players))
    ...
    def _ensure_player_colors(self, num_players):
        extra_colors = ["red", "yellow", "purple", "orange", "cyan", "magenta", "brown"]
        while len(self.player_colors) < num_players:
            next_color = extra_colors[(len(self.player_colors) - 2) % len(extra_colors)]
            self.player_colors.append(next_color)
