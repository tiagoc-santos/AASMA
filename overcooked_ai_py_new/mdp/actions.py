...
class Action(object):
    ...
    @staticmethod
    def joint_action_index_tuples(num_players):
        """Return all action-index tuples for a joint action of size num_players."""
        return list(itertools.product(range(len(Action.INDEX_TO_ACTION)), repeat=num_players))
